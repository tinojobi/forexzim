UPDATE blog_posts SET
    excerpt = 'ZiG is Zimbabwe''s gold-backed currency launched in April 2024. You''ve seen it on price tags and rate boards, so here''s what it actually is, how the rate works, and whether it''s worth trusting.',
...
<p>When ZiG launched, existing ZWL balances were converted at a rate of <strong>2,498 ZWL = 1 ZiG</strong>. So ZWL 24,980 became ZiG 10. The ZWL was demonetised (taken out of circulation entirely) and ZiG notes and coins replaced it.</p>
...
<p>The number most people watch isn't the official rate itself. The real indicator is the gap between the official rate and the parallel market rate. A small gap means the two are roughly in sync. A big gap means the official rate is being propped up while the market tells a different story.</p>
