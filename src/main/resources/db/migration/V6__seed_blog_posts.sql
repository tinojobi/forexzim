INSERT INTO blog_posts (title, slug, excerpt, content, author, published_at, created_at, updated_at, status, meta_description, read_time_minutes)
VALUES (
    'What is Zimbabwe Gold (ZiG)? A Plain-English Guide',
    'what-is-zimbabwe-gold-zig',
    'ZiG is Zimbabwe''s gold-backed currency launched in April 2024. You''ve seen it on price tags and rate boards — here''s what it actually is, how the rate works, and whether it''s worth trusting.',
    $$<p>By now you've probably seen "ZiG" on price tags, heard it on the news, or watched the rate move on ZimRate. But a lot of people still aren't totally sure what it actually is — especially given how many currencies Zimbabwe has been through. So here's a no-nonsense breakdown.</p>
...
<ul>
    ...
    '2026-04-14 09:00:00',
    'PUBLISHED',
    'What is ZiG? Zimbabwe Gold is Zimbabwe''s gold-backed currency launched in April 2024. Learn how the exchange rate works and where to check today''s rate.',
    6
);
