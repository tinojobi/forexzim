...
The government switched petrol blending from E5 to E20. That means 20% of what goes into your tank is now locally produced ethanol, up from 5%. On paper, this should lower prices because ethanol is not hit with the same crushing taxes as imported petrol. The petrol tax bill is over 85 cents a litre, according to [The Zimbabwean](https://www.thezimbabwean.co/2026/03/zimbabwe-considers-raising-ethanol-blend-from-e5-to-e20-to-ease-fuel-costs/). By swapping out a fifth of that taxed fuel for tax-exempt ethanol, the government can claim a price reduction.

Here is the catch. Ethanol costs US$1.10 a litre to produce locally, according to [ZERA's own March 2026 price build-up](https://www.thezimbabwean.co/2026/03/why-e20-blending-will-not-help-reduce-fuel-costs-but-will-reduce-vehicle-mileage-and-damage-our-engines/). The FOB price of imported petrol is US$1.09. The ethanol is more expensive than the fuel it replaces. The only reason the pump price drops is that the government chose not to tax the ethanol portion. That is not a market saving. It is a tax decision dressed up as an energy policy.
...
A [detailed breakdown in The Zimbabwean](https://www.thezimbabwean.co/2026/04/the-54-cent-illusion-why-zimbabwes-diesel-tax-cut-didnt-lower-prices/) pointed out that if the government's 54-cent diesel tax cut from earlier this month had been real, diesel should have dropped to around US$1.51. It went up instead. The same analysis noted that Brent crude has actually fallen since mid-March, from US$112 to around US$103-109 per barrel. Global prices are down. Local prices barely moved. The maths does not add up.

## What about miners and businesses

For the mining sector, which generates over 70% of Zimbabwe's export earnings, diesel at US$2.09 is still brutal. As we covered in our [previous analysis of fuel prices squeezing mines](https://zimrate.com/blog/zimbabwes-fuel-prices-are-squeezing-mines-commuters-and-the-zig), opencast operations and generator-dependent sites have no way to dodge these costs. The 2-cent drop on diesel is noise, not relief.

Commuters might feel the petrol drop more directly if transport operators pass it on. They probably will not. A [NewsDay editorial](https://www.newsday.co.zw/editorials/article/200053953/address-fuel-price-distortion-as-well) this week pointed out that even when the government suspended bus import duties, there was no mechanism to ensure operators would lower fares. Same logic applies here.
...
If you are tracking the ZiG/USD exchange rate alongside fuel costs, check the [ZimRate dashboard](https://zimrate.com) for the latest parallel and official rates. Fuel is priced in USD, but the ripple effects hit ZiG-denominated wages and prices fast.
